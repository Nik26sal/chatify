...
const {createChat, deleteChat, changeGroupName, changeGroupAvatar, addMemeber,removeMember,changeDescription} = require('../controller/chatController.js')
...
router.patch('addMemeber',authorizeduser,addMemeber);
